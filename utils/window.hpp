...
public:
	...
	/**
	 * @return The underlying GLFWwindow pointer.
	 */
	...
	/**
	 * @brief Global scroll callback passed to GLFW, forwarding scroll events.
	 */
	static void scrollCallback(GLFWwindow* window, double xoffset, double yoffset) {
		...
		if (ptr) {
			...
			if (winPtr->mScrollCallback) {
				winPtr->mScrollCallback(window, xoffset, yoffset);
			}
		}
	}
	...
	/**
	 * @brief Registers a custom mouse scroll callback.
	 * @param aScrollCallback Function matching GLFW scroll-callback signature.
	 */
